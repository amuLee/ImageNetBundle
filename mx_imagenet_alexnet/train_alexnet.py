...
logging.basicConfig(level=logging.DEBUG,
    filename="training_{}.log".format(args["start-epoch"]),
    filemode="w")
...
if args["start-epoch"] <= 0:
    # build the AlexNet architeture
...
# otherwise, a specific checkpoint was supplied
    ...
    print("[INFO] loading epoch {}...".format(args["start-epoch"]))
